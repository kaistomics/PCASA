##############################################
#### Step 1: Install and set working directory
##############################################
...
##############################################
#### Step 2: Prepare a readcount-input 
##############################################

f_name <- 'scrna.seurat-raw.counts.tsv'
exp.rawdata <- read.csv(f_name, sep="\t", row.names=1)


##############################################
#### Step 3: Run the copykat
##############################################
...
write.table(tumor.cells, file="test_copykat_tumor_cells.txt", sep="\t", quote=F)
